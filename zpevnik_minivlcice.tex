...
\PISNICKA{diky} %
\OBRAZEK{\vfill}{0.4}{diky}{}
\PISNICKA{do_tvych_starosti} %

\PISNICKA{hvezdy_tise_vysly} % 
\OBRAZEK{\vfill}{0.4}{hvezdy_tise_vysly}{}
...
\OBRAZEK{\vfill}{0.4}{koho_vcelky_chvali}{}
\PISNICKA{moudrost_mi_pane_davej} %
\OBRAZEK{\vfill}{0.4}{moudrost_mi_pane_davej}{}
% Pán Bůh nás má všechny rád
\PISNICKA{nekdo_me_vede_za_ruku} % 
\OBRAZEK{\vfill}{0.4}{nekdo_me_vede_za_ruku}{}
\PISNICKA{neni_lepsi_na_tom_svete} %
\OBRAZEK{\vfill}{0.4}{neni_lepsi_na_tom_svete}{}
...
\input{songs/honky_tonky_blues}% Honky tonky blues
\PISNICKA{jonatan} % 
